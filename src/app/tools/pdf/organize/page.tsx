...
export default function OrganizePdfPage() {
  ...
  const organizeFaqs = [
    {
      question: 'สามารถสลับ ลบ และหมุนหน้า PDF ในครั้งเดียวได้ไหม?',
      answer: 'ได้เลยครับ! ในหน้าตัวอย่าง คุณสามารถลากวาง (Drag & Drop) เพื่อสลับหน้า กดไอคอนถังขยะเพื่อลบหน้าที่ไม่ต้องการ หรือกดไอคอนหมุนเพื่อแก้ไขหน้าที่ตีลังกาได้ในเวลาเดียวกันก่อนกดสร้างไฟล์ใหม่',
    },
    {
      question: 'จัดระเบียบหน้าแล้วคุณภาพไฟล์จะลดลงไหม?',
      answer: 'ไม่ลดลงครับ เครื่องมือจัดเรียงหน้า PDF ของเราจะใช้หน้ากระดาษต้นฉบับดั้งเดิม ไม่มีการบีบอัดเพิ่มหรือลดคุณภาพใดๆ ทั้งสิ้น ข้อมูลทุกอย่างจะคมชัดเหมือนเดิม 100%',
    },
    {
      question: 'ดูภาพตัวอย่างแต่ละหน้าก่อนจัดเรียงได้ไหม?',
      answer: 'ได้ครับ เมื่ออัปโหลดไฟล์ ระบบจะดึงภาพตัวอย่างขนาดเล็ก (Thumbnail) ของทุกหน้ามาแสดงผลให้คุณเห็นชัดเจน ทำให้จัดระเบียบหน้าได้ง่ายและไม่ผิดพลาด',
    },
  ];

  const organizeArticle = (
    <div className="text-slate-700 dark:text-slate-300 space-y-8 leading-relaxed">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">เครื่องมือจัดเรียงหน้า PDF ย้าย ลบ หมุน อย่างอิสระ</h2>
        <p>จัดระเบียบเอกสาร PDF ของคุณให้สมบูรณ์แบบ ไม่ว่าคุณจะสแกนเอกสารมาสลับหน้า มีหน้ากระดาษว่างหลุดเข้ามา หรือเอกสารบางหน้ากลับหัว คุณสามารถใช้เครื่องมือนี้จัดการทุกปัญหาได้ในหน้าจอเดียว</p>
        <ol className="list-decimal pl-6 mt-4 space-y-2">
          <li><strong>อัปโหลดเอกสาร:</strong> เลือกไฟล์ PDF ที่คุณต้องการจัดระเบียบ</li>
          <li><strong>ลากและวาง:</strong> ใช้เมาส์คลิกค้างที่หน้ากระดาษแล้วลากเพื่อสลับตำแหน่ง (Drag & Drop) หรือกดลบ/หมุนหน้าตามต้องการ</li>
          <li><strong>บันทึกและดาวน์โหลด:</strong> กดปุ่มจัดระเบียบ ระบบจะสร้างไฟล์ PDF ไฟล์ใหม่ที่เรียงหน้าถูกต้องให้คุณทันที</li>
        </ol>
      </div>
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">ความเป็นส่วนตัวคือสิ่งสำคัญที่สุด</h2>
        <p>เราเข้าใจดีว่าเอกสารหลายฉบับมีความสำคัญและเป็นความลับ เครื่องมือจัดเรียง PDF นี้ทำงานบนเบราว์เซอร์ของคุณล้วนๆ ไฟล์ของคุณจึงไม่ถูกอัปโหลดขึ้นเซิร์ฟเวอร์ภายนอก ทำให้เอกสารสัญญาหรือข้อมูลส่วนบุคคลปลอดภัยจากการถูกดักจับ 100%</p>
      </div>
    </div>
  );

  return (
    <PdfToolLayout tool={tool} currentStep={step} article={organizeArticle} faqs={organizeFaqs}>
      {error && (
        <div className="mb-6">
