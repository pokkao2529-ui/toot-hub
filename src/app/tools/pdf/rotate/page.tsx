...
export default function RotatePdfPage() {
  ...
  const rotateFaqs = [
    {
      question: 'สามารถหมุนไฟล์ PDF เฉพาะบางหน้าได้หรือไม่?',
      answer: 'ได้แน่นอนครับ คุณสามารถคลิกเลือกเฉพาะหน้าที่ตะแคงอยู่ (เช่น หน้า 2 และ 4) แล้วกดไอคอนลูกศรหมุนเฉพาะหน้านั้นๆ ได้ทันทีโดยไม่กระทบกับหน้าอื่น',
    },
    {
      question: 'หมุนหน้าเสร็จแล้ว ข้อมูลในเอกสารจะยังเหมือนเดิมไหม?',
      answer: 'ข้อมูลทุกอย่าง ตัวอักษร และรูปภาพจะยังคงความคมชัดและอยู่ในตำแหน่งเดิม 100% ครับ เราทำแค่พลิกทิศทางการแสดงผล (Orientation) ของหน้ากระดาษเท่านั้น ไม่มีการลดทอนคุณภาพ',
    },
    {
      question: 'ไฟล์ที่หมุนแล้ว จะปลอดภัยไหม?',
      answer: 'ไฟล์ของคุณปลอดภัย 100% เพราะทุกขั้นตอนการอัปโหลด การแสดงพรีวิว และการหมุนหน้ากระดาษ เกิดขึ้นในเบราว์เซอร์ของคุณล้วนๆ ไม่มีไฟล์ใดถูกส่งไปยังเซิร์ฟเวอร์ของเราเลย',
    },
  ];
  ...
  const rotateArticle = (
    <div className="text-slate-700 dark:text-slate-300 space-y-8 leading-relaxed">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">โปรแกรมหมุนไฟล์ PDF แก้ไขหน้าเอกสารตะแคงออนไลน์</h2>
        <p>หลายครั้งที่เราสแกนเอกสารมาแล้วพบว่ามีบางหน้าตีลังกาหรือตะแคงข้าง ทำให้ยากต่อการอ่าน เครื่องมือหมุน PDF (Rotate PDF) ของเราให้คุณคลิกหมุนเฉพาะหน้าที่ผิดพลาดให้กลับมาตั้งตรงได้อย่างรวดเร็ว ในหน้าพรีวิวที่ใช้งานง่ายสุดๆ</p>
        <ol className="list-decimal pl-6 mt-4 space-y-2">
          <li><strong>อัปโหลด PDF:</strong> เลือกไฟล์ที่มีหน้ากระดาษตะแคงหรือกลับหัว</li>
          <li><strong>หมุนหน้า:</strong> คลิกไอคอนหมุน 90 องศา, 180 องศา บนหน้าที่ต้องการ หรือจะเลือกหมุนทีเดียวพร้อมกันหลายหน้าก็ได้</li>
          <li><strong>บันทึก:</strong> ตรวจสอบความเรียบร้อย แล้วกดบันทึกเพื่อดาวน์โหลดไฟล์ที่ตั้งตรงพร้อมใช้อ่านได้ทันที</li>
        </ol>
      </div>
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">แสดงภาพตัวอย่างก่อนหมุน (Thumbnail Preview)</h2>
        <p>ไม่ต้องเดาว่าหน้าไหนต้องหมุนไปทางไหน เพราะเรามีระบบดึงภาพตัวอย่างขนาดย่อมาให้คุณดูแบบเรียลไทม์ ทำให้คุณสามารถเห็นภาพรวมของเอกสารทั้งหมด และจัดการหมุนหน้าได้อย่างถูกต้องแม่นยำที่สุด</p>
      </div>
    </div>
  );

  return (
    <PdfToolLayout tool={tool} currentStep={step} article={rotateArticle} faqs={rotateFaqs}>
      {error && (
        <div className="mb-6">
